...
9. Test the downloaded installer and a real A-to-B Sparkle installation. B repeats all affected gates with a new build/version and becomes the recommended release. Preserve the previous installer for update proof.
